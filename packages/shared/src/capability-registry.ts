...
export const CAPABILITY_REGISTRY: CapabilityEntry[] = [
  ...
  // ── 2. flat_bracket ───────────────────────────────────────────────────────
  {
    ...
    required_dimensions: [
      ...
      { name: "hole_count",    unit: "count", min: 0,  max: 20,  description: "Number of mounting holes" },
  ...
  // ── 10. simple_jig ────────────────────────────────────────────────────────
  {
    ...
    required_dimensions: [
      ...
      { name: "height", unit: "mm", min: 3, max: 500, description: "Overall height of the jig" },
    ],
    optional_dimensions: [],
    validation_rules: [],
    question_strategy: {
      primary_question: "What are the overall dimensions (L × W × H) of the jig?",
      dimension_order: ["length", "width", "height"],
      example_values: { length: 60, width: 40, height: 20 },
    },
    generator_version: "1.0.0",
    maturity_level: "proven",
    demo_eligible: false,
