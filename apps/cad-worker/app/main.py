...
from app.api.generate_custom import router as generate_custom_router
...
app.include_router(generate_custom_router, prefix="/generate-custom", tags=["generate-custom"])
