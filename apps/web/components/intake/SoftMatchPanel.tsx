  ...
  return (
    <div className="rounded-xl border border-brand-600/50 bg-steel-800/60 p-6 space-y-5">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-steel-400 mt-0.5">
            Based on your description, the closest part is:{" "}
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 h-2 rounded-full bg-steel-700">
          <div
      ...
      <div>
        <p className="text-xs font-semibold text-steel-500 uppercase tracking-wide mb-3">
          Inferred Dimensions — edit any value before generating
        </p>
            ...
            <div key={key} className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-1">
                <input
                  ...
                  placeholder={missing_dims.includes(key) ? "Enter value" : undefined}
                  className="w-full rounded-md bg-steel-700 border border-steel-600 text-steel-100 text-sm px-2 py-1.5 focus:outline-none focus:ring-1 focus:ring-brand-500 placeholder:text-steel-600"
                />
                <span className="text-xs text-steel-500 shrink-0">mm</span>
              </div>
            </div>
          ))}
        </div>
